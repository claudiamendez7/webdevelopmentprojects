                ...
                <div className="country__details">
                    ...
                    <div className='panel'>
                        ...
                        <div className="right__panel">
                            <p><span className="data__name">Top Level Domain: </span>{countryData?.topLevelDomain?.length}</p>
                            <p><span className="data__name">Currencies: </span>{countryData?.currencies?.length}</p>
                            <p><span className="data__name">Languages: </span>{countryData?.languages?.length}</p>
                            {/* Checking if these value are undefined then hide them */}
